    ...
    D: Database,
{
    ...
    // pub state: MempoolTxnProcessorState,
    ...
    D: Database + 'static,
{
    ...
    // fn get_state(&self) -> MempoolTxnProcessorState {
    //     match self.state.lock() {
    //         Ok(state) => return state.clone(),
    //         Err(_) => {
    //             self.send_err_msg(MempoolTxnProcessorError::FailedToAcquireStateLock);
    //             MempoolTxnProcessorState::Inactive
    //         }
    //     }
    // }
    // fn set_state(&self, new_state: MempoolTxnProcessorState) {
    //     match self.state.lock() {
    //         Ok(mut state) => {
    //             *state = new_state;
    //         }
