...
export const signTransaction = async (tx: { sender_address: string; amount: number; sender_public_key: string; receiver_address: string; private_key: string; nonce: number; timestamp: number; token: { symbol: string; decimals: number; name: string } }) => {
    try {
...
export const createTransaction = async (tx: { sender_address: string; amount: number; sender_public_key: string; receiver_address: string; private_key: string; nonce: number; timestamp: number; token: { symbol: string; decimals: number; name: string } }) => {
    try {
