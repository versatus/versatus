...
impl Election for Quorum{
   ...
   ///a miner calls this fxn to generate a u64 seed for the election using the vrrb_vrf crate
...
impl Quorum{
  ///makes a new Quorum and initializes seed, child block height, and child block timestamp
