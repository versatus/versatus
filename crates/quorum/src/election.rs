pub trait Election {
    ...
    ///re-make seed and nonce up claims to run a new election in case of electoin failure
    fn nonce_claims_and_new_seed(&mut self, claims: Self::Ballot) -> Result<Self::Ballot, Self::Error>;
}
