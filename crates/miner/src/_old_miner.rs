...
impl OldMiner {
    /// Abandons the claim of a miner that fails to propose a block in the
    ...
    /// claim.
    pub fn check_my_claim(&mut self, nonce: u128) -> Result<bool> {
        todo!()
    ...
    pub fn genesis(&mut self) -> Option<Result<Block>> {
        todo!()
