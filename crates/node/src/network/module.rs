...
use primitives::{KademliaPeerId, NodeId, NodeType, ValidatorPublicKey, RawSignature};
...
impl NetworkModule {
    ...
    pub async fn broadcast_convergence_block_partial_signature(&mut self, sig: RawSignature) -> Result<()> {
