...
/// Spawns a thread for handling the syncing of peers into a neighboring quorum
/// pool. The thread will continue to attempt to send its event until
/// the peer leaves the network.
