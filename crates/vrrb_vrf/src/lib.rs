...
mod tests {
    ...
    fn same_seed_equals_same_random_8() {
        ...
        let message = b"test";
        let mut vvrf1: VVRF = VVRF::new(message, keypair_1.clone());
        let mut vvrf2: VVRF = VVRF::new(message, keypair_1);
    ...
    fn hash_is_verifiable() {
        let keypair_1 = KeyPair::random();
        let message = b"test";
        let vvrf: VVRF = VVRF::new(message, keypair_1);
    ...
    fn generates_word_from_lib() {
        let keypair_1 = KeyPair::random();
        let message = b"test";
        let mut vvrf: VVRF = VVRF::new(message, keypair_1);
    ...
    fn generates_right_num_words() {
        let keypair_1 = KeyPair::random();
        let message = b"test";
        let mut vvrf1: VVRF = VVRF::new(message, keypair_1);
