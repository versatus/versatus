...
pub type TxnList = LinkedHashMap<TransactionDigest, dyn Transaction>;
pub type QuorumCertifiedTxnList = LinkedHashMap<TransactionDigest, QuorumCertifiedTxn<dyn Transaction>>;
