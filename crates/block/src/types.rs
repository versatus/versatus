...
pub type TxnList<'a> = LinkedHashMap<TransactionDigest, dyn Transaction<'a>>;
pub type QuorumCertifiedTxnList<'a> = LinkedHashMap<TransactionDigest, QuorumCertifiedTxn<dyn Transaction<'a>>>;
