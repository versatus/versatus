...
pub struct NodeAddr {
    ...
    pub addr_set: HashSet<Multiaddr>,
}
...
pub enum NodePoolOp {
    Add(String,Multiaddr),
    Remove(String,Multiaddr),
}
...
impl LeftRightNodePoolDB {
    ...
    pub fn add_node(&mut self, node_id: &String, node_addr: Multiaddr) -> Result<()> {
    ...
    pub fn remove_node(&mut self, node_id: &String) -> Result<()> {
        ...
        self.write
            .append(NodePoolOp::Remove(node_id.clone(), Multiaddr::empty()))
            .publish();
