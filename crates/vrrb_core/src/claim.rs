...
use primitives::{Address, PublicKey, RaptorUdpPort, SerializedSecretKey};
...
impl Claim {
    ...
    /// * `raptor_port`: The `raptor_port` parameter is of u16 representing udp port for communicating raptor packets.
